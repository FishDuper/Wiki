...
Note: this is the default mods directory, if you already run the game modded you should consider changing the directory to `%appdata%\.minecraft\mcsr ranked\mods`
![example setup](https://img001.prntscr.com/file/img001/W-Pq9B1kQkiqGH_NnbGa3g.png)
